...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 20, 2024 at 02:58 AM
...
(23, 72, 1010, 3, 0, '2024-09-29 18:33:40', '2024-10-20 07:58:17', 'unclaimed'),
...
(28, 57, 1012, 7, 0, '2024-09-29 18:33:40', '2024-10-20 07:27:50', 'unclaimed'),
...
(34, 68, 1014, 3, 0, '2024-10-01 11:30:33', '2024-10-20 08:10:38', 'unclaimed'),
(35, 68, 1015, 2, 0, '2024-10-01 11:56:19', '2024-10-20 08:49:07', 'unclaimed'),
(37, 77, 1016, 1, 0, '2024-10-01 12:05:34', '2024-10-20 08:54:55', 'unclaimed'),
(39, 75, 1017, 2, 0, '2024-10-01 12:08:13', '2024-10-20 08:56:52', 'unclaimed'),
(41, 81, 1019, 15, 0, '2024-10-01 14:11:48', '2024-10-20 06:55:30', 'unclaimed');
...
(43, 37, 1016, 1, 2, 375.00, 750.00, 'Updated item quantities', '3', '2024-10-12 13:23:22'),
...
(78, 37, 1016, 2, 3, 750.00, 1125.00, 'Updated item quantities', '3', '2024-10-14 14:22:54'),
(79, 37, 1016, 3, 4, 1125.00, 1500.00, 'Updated item quantities', '3', '2024-10-14 14:31:49'),
(80, 37, 1016, 4, 5, 1500.00, 1875.00, 'Updated item quantities', '3', '2024-10-14 14:32:23'),
...
(85, 37, 1016, 5, 6, 1875.00, 2250.00, 'Updated item quantities', '2', '2024-10-16 21:48:16'),
...
(105, 37, 1016, 6, 2, 2250.00, 750.00, 'Updated item quantities', '2', '2024-10-20 02:51:12'),
(106, 37, 1016, 2, 1, 750.00, 375.00, 'Updated item quantities', '2', '2024-10-20 02:54:55'),
...
(1010, '2024-09-25 10:00:12', 'completed', '2024-10-20 07:58:40'),
(1011, '2024-09-25 12:59:33', 'completed', '2024-10-20 07:21:21'),
(1012, '2024-09-25 13:04:17', 'completed', '2024-10-20 07:28:15'),
(1013, '2024-09-26 05:13:26', 'completed', '2024-10-20 07:44:51'),
(1014, '2024-10-01 03:30:33', 'completed', '2024-10-20 08:11:33'),
(1015, '2024-10-01 03:56:19', 'completed', '2024-10-20 08:49:19'),
(1016, '2024-10-01 04:05:34', 'completed', '2024-10-20 08:55:03'),
(1017, '2024-10-01 04:08:13', 'completed', '2024-10-20 08:57:06'),
(1018, '2024-10-01 04:09:58', 'pending', '2024-10-20 08:55:16'),
(1019, '2024-10-01 06:11:48', 'pending', '2024-10-20 08:55:13'),
(1020, '2024-10-01 06:13:38', 'completed', '2024-10-20 06:58:45');
...
--
ALTER TABLE `item_modifications`
  MODIFY `modification_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=109;
...
--
ALTER TABLE `order_modifications`
  MODIFY `modification_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
...
--
ALTER TABLE `transaction_modifications`
  ADD CONSTRAINT `transaction_modifications_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `orders` (`order_id`) ON DELETE CASCADE;
COMMIT;
